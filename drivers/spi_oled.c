...
//clear the oled,The effect is like an OLED without power
...
{  
	...
	{  
		...
		OLED_WR_Byte (0x00,OLED_CMD);      //set show position—Column low address
		OLED_WR_Byte (0x10,OLED_CMD);      //set show position—Column high address   
		for(n=0;n<128;n++)
